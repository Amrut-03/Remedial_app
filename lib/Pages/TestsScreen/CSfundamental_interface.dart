...
class CSFundamentalInterface extends StatefulWidget {
  String subject;
  CSFundamentalInterface({
    Key? key,
    required this.subject,
  }) : super(key: key);
  @override
  State<CSFundamentalInterface> createState() => _CSFundamentalInterfaceState();
}

class _CSFundamentalInterfaceState extends State<CSFundamentalInterface> {
  ...
  getresult({required String subject, required int marks}) {
    final user = FirebaseAuth.instance.currentUser;
    final now = DateTime.now();
    final formattedDate = DateFormat('yyyy-MM-dd – kk:mm').format(now);
    FirebaseFirestore.instance.collection('users').doc(user!.email).set({
      "result": {
        formattedDate: {"marks": marks, "subject": subject}
      }
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            next_page();
                            getresult(subject: widget.subject, marks: result);
                          },
                          style: ElevatedButton.styleFrom(
