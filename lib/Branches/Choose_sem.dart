...
import 'package:Remedial_App/Computer Dept/Semester_1.dart';
import 'package:Remedial_App/Computer Dept/Semester_2.dart';
import 'package:Remedial_App/Computer Dept/Semester_3.dart';
import 'package:Remedial_App/Computer Dept/Semester_4.dart';
import 'package:Remedial_App/Computer Dept/Semester_5.dart';
...
class choose_Sem extends StatelessWidget {
  ...
  final double Right;
  const choose_Sem({
    super.key, required this.branch, required this.assets,
    required this.clr, required this.Top, required this.Bottom,
