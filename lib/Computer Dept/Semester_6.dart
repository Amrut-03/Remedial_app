                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            ...
                            child: Text('Compiler Design',style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            ...
                            child: Text('Machine Learning',textAlign: TextAlign.center,style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            padding: const EdgeInsets.only(left: 30,right: 20),
                            child: Text('Internet of Things',style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            padding: const EdgeInsets.only(left: 30,right: 20),
                            child: Text('Development Engineering',textAlign: TextAlign.center,style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
