                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            ...
                            child: Text('Mathematics 4',style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            padding: const EdgeInsets.only(left: 30,right: 20),
                            child: Text('Design Analysis and Algorithm',style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            ...
                            child: Text('Basic Human Right',textAlign: TextAlign.center,style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            padding: const EdgeInsets.only(left: 30,right: 20),
                            child: Text('Digital Logic and Design Algorithm',style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Padding(
                            padding: const EdgeInsets.only(left: 30,right: 20),
                            child: Text('Operating System',textAlign: TextAlign.center,style: GoogleFonts.poppins(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                              color: Colors.white,
                            ),),
